...
export const UI_TRANSLATIONS = {
  de: {
    ...
    offlineNetworkTitle: "Offline-Betrieb & Netzwerk",
    forceOfflineTitle: "Offline-Modus erzwingen",
    forceOfflineDesc: "Simuliert instabiles oder fehlendes Schul-WLAN. Nutzt rein das lokale Schul-Lexikon.",
    offlinePacksTitle: "Installierte Offline-Sprachpakete",
    ready100: "100% Bereit",
    offlinePacksDesc: "Folgende Sprachen und Redemittel sind direkt auf diesem Gerät gesichert:",
    schoolLexicon: "Schul-Lexikon",
    moreLanguagesTitle: "Weitere Sprachen installieren & verwalten",
    moreLanguagesBadge: "Generator",
    moreLanguagesDesc: "Brauchst du weitere Sprachen für den Unterricht? Ein Klick genügt: Die App lädt einmalig alle Schulsätze herunter und speichert sie fest auf diesem Gerät für die Offline-Nutzung.",
    popularLanguages: "Beliebte Schul-Sprachen (1-Klick-Installation):",
    installedBadge: "Installiert",
    deleteBtn: "Löschen",
    installBtn: "Installieren",
    addCustomLangBtn: "Andere Sprache manuell hinzufügen...",
    installCustomTitle: "Beliebige Sprache installieren",
    langCodeLabel: "Code (ISO)",
    langNameLabel: "Name",
    langFlagLabel: "Flagge",
    installCustomAction: "Paket jetzt generieren & installieren",
    aiStatusTitle: "Schul-KI (Google Gemini)",
    aiActiveTitle: "Automatisch aktiviert & geschützt",
    aiActiveDesc: "Die KI-Übersetzung wird zentral und sicher von der Heimbürgeschule bereitgestellt. Du brauchst dich um keinen Schlüssel zu kümmern – die App ist sofort für dich startklar!",
    audioTitle: "Sprachausgabe & Audio",
    speedLabel: "Vorlesegeschwindigkeit",
    speedSlow: "0.75x (Langsam / Schulanfänger)",
    speedNormal: "1.0x (Normal)",
    speedFast: "1.25x (Schnell)",
    autoPronounceTitle: "Automatisch vorlesen",
    autoPronounceDesc: "Liest das Übersetzungsergebnis sofort nach Fertigstellung laut vor.",
    voiceSamplesTitle: "Natürliche Stimmproben anhören",
    voiceSamplesBadge: "Google HD & Offline",
    voiceSamplesDesc: "Die App nutzt hochwertige Stimmen für natürliche Aussprache im Unterricht. Offline greift sie auf die beste Systemstimme deines Geräts zu:",
    voiceListenBtn: "Hörprobe",
    voiceStopBtn: "Stopp",
    activeVoiceLabel: "Aktive Wiedergabe:",
    activeVoiceUsedIn: "Wird im Übersetzer und bei allen Schulsätzen genutzt.",
    appSaveTipTitle: "Tipp: Als App auf dem iPad, iPhone oder Android speichern",
    appSaveTipDesc: "Auf dem iPad/iPhone: Tippe in Safari auf das Teilen-Symbol und wähle „Zum Home-Bildschirm“. Auf Android: Tippe im Menü auf „App installieren“ oder „Zum Startbildschirm hinzufügen“.",
  ...
  uk: {
    ...
    // Settings Sections & Details
    offlineNetworkTitle: "Автономний режим і мережа",
    forceOfflineTitle: "Примусовий офлайн-режим",
    forceOfflineDesc: "Імітує нестабільний або відсутній шкільний Wi-Fi. Використовує лише локальний шкільний словник.",
    offlinePacksTitle: "Встановлені офлайн-мовні пакети",
    ready100: "100% Готово",
    offlinePacksDesc: "Ці мови та шкільні фрази збережені безпосередньо на цьому пристрої:",
    schoolLexicon: "Шкільний словник",
    moreLanguagesTitle: "Встановити та керувати іншими мовами",
    moreLanguagesBadge: "Генератор",
    moreLanguagesDesc: "Потрібні інші мови для уроків? Один клік: додаток завантажує всі шкільні фрази та зберігає їх на пристрої для роботи без інтернету.",
    popularLanguages: "Популярні шкільні мови (швидке встановлення):",
    installedBadge: "Встановлено",
    deleteBtn: "Видалити",
    installBtn: "Встановити",
    addCustomLangBtn: "Додати іншу мову вручну...",
    installCustomTitle: "Встановити будь-яку мову",
    langCodeLabel: "Код (ISO)",
    langNameLabel: "Назва",
    langFlagLabel: "Прапор",
    installCustomAction: "Згенерувати та встановити пакет",
    aiStatusTitle: "Шкільний ШІ (Google Gemini)",
    aiActiveTitle: "Автоматично активовано та захищено",
    aiActiveDesc: "ШІ-переклад надається централізовано та безпечно школою Heimbürgeschule. Тобі не потрібен ключ – додаток одразу готовий до роботи!",
    audioTitle: "Озвучення та звук",
    speedLabel: "Швидкість читання",
    speedSlow: "0.75x (Повільно / Для початківців)",
    speedNormal: "1.0x (Звичайно)",
    speedFast: "1.25x (Швидко)",
    autoPronounceTitle: "Читати автоматично",
    autoPronounceDesc: "Вголос читає результат перекладу одразу після готовності.",
    voiceSamplesTitle: "Прослухати зразки голосу",
    voiceSamplesBadge: "Google HD та офлайн",
    voiceSamplesDesc: "Додаток використовує якісні голоси для правильної вимови на уроці. Без інтернету працює системний голос твого пристрою:",
    voiceListenBtn: "Зразок",
    voiceStopBtn: "Стоп",
    activeVoiceLabel: "Активне озвучення:",
    activeVoiceUsedIn: "Використовується в перекладачі та для всіх шкільних фраз.",
    appSaveTipTitle: "Порада: Зберегти як додаток на iPad, iPhone або Android",
    appSaveTipDesc: "На iPad/iPhone: натисни значок «Поділитися» в Safari та вибери «На початковий екран». На Android: натисни в меню «Встановити додаток».",
  ...
  ru: {
    ...
    // Settings Sections & Details
    offlineNetworkTitle: "Автономный режим и сеть",
    forceOfflineTitle: "Принудительный офлайн-режим",
    forceOfflineDesc: "Имитирует нестабильный или отсутствующий школьный Wi-Fi. Использует только локальный школьный словарь.",
    offlinePacksTitle: "Установленные офлайн-языковые пакеты",
    ready100: "100% Готово",
    offlinePacksDesc: "Эти языки и школьные фразы сохранены непосредственно на этом устройстве:",
    schoolLexicon: "Школьный словарь",
    moreLanguagesTitle: "Установить и настроить другие языки",
    moreLanguagesBadge: "Генератор",
    moreLanguagesDesc: "Нужны другие языки для уроков? Один клик: приложение загружает все школьные фразы и сохраняет их на устройстве для работы без интернета.",
    popularLanguages: "Популярные школьные языки (быстрая установка):",
    installedBadge: "Установлено",
    deleteBtn: "Удалить",
    installBtn: "Установить",
    addCustomLangBtn: "Добавить другой язык вручную...",
    installCustomTitle: "Установить любой язык",
    langCodeLabel: "Код (ISO)",
    langNameLabel: "Название",
    langFlagLabel: "Флаг",
    installCustomAction: "Сгенерировать и установить пакет",
    aiStatusTitle: "Школьный ИИ (Google Gemini)",
    aiActiveTitle: "Автоматически активирован и защищен",
    aiActiveDesc: "ИИ-перевод предоставляется централизованно и безопасно школой Heimbürgeschule. Ключ не нужен — приложение сразу готово к работе!",
    audioTitle: "Озвучка и звук",
    speedLabel: "Скорость чтения",
    speedSlow: "0.75x (Медленно / Для начинающих)",
    speedNormal: "1.0x (Обычно)",
    speedFast: "1.25x (Быстро)",
    autoPronounceTitle: "Читать автоматически",
    autoPronounceDesc: "Вслух читает результат перевода сразу после готовности.",
    voiceSamplesTitle: "Прослушать образцы голоса",
    voiceSamplesBadge: "Google HD и офлайн",
    voiceSamplesDesc: "Приложение использует качественные голоса для правильного произношения на уроке. Без интернета работает системный голос устройства:",
    voiceListenBtn: "Образец",
    voiceStopBtn: "Стоп",
    activeVoiceLabel: "Активное воспроизведение:",
    activeVoiceUsedIn: "Используется в переводчике и для всех школьных фраз.",
    appSaveTipTitle: "Совет: Сохранить как приложение на iPad, iPhone или Android",
    appSaveTipDesc: "На iPad/iPhone: нажми значок «Поделиться» в Safari и выбери «На экран „Домой“». На Android: нажми в меню «Установить приложение».",
  ...
  en: {
    ...
    // Settings Sections & Details
    offlineNetworkTitle: "Offline Mode & Network",
    forceOfflineTitle: "Force offline mode",
    forceOfflineDesc: "Simulates unstable or missing school Wi-Fi. Uses only the local school dictionary.",
    offlinePacksTitle: "Installed offline language packs",
    ready100: "100% Ready",
    offlinePacksDesc: "The following languages and phrases are stored directly on this device:",
    schoolLexicon: "School lexicon",
    moreLanguagesTitle: "Install & manage more languages",
    moreLanguagesBadge: "Generator",
    moreLanguagesDesc: "Need more languages for class? One click downloads all school phrases and saves them for 100% offline use.",
    popularLanguages: "Popular school languages (1-click install):",
    installedBadge: "Installed",
    deleteBtn: "Delete",
    installBtn: "Install",
    addCustomLangBtn: "Add custom language manually...",
    installCustomTitle: "Install any language",
    langCodeLabel: "Code (ISO)",
    langNameLabel: "Name",
    langFlagLabel: "Flag",
    installCustomAction: "Generate & install package now",
    aiStatusTitle: "School AI (Google Gemini)",
    aiActiveTitle: "Automatically enabled & secured",
    aiActiveDesc: "AI translation is safely provided by Heimbürgeschule. No API key needed – ready for you immediately!",
    audioTitle: "Speech & Audio",
    speedLabel: "Reading speed",
    speedSlow: "0.75x (Slow / Beginners)",
    speedNormal: "1.0x (Normal)",
    speedFast: "1.25x (Fast)",
    autoPronounceTitle: "Read aloud automatically",
    autoPronounceDesc: "Speaks the translation aloud immediately once completed.",
    voiceSamplesTitle: "Listen to natural voice samples",
    voiceSamplesBadge: "Google HD & Offline",
    voiceSamplesDesc: "The app uses clear studio voices in class. When offline, it automatically falls back to your device's system voice:",
    voiceListenBtn: "Sample",
    voiceStopBtn: "Stop",
    activeVoiceLabel: "Active voice:",
    activeVoiceUsedIn: "Used in translator and for all school phrases.",
    appSaveTipTitle: "Tip: Save as app on iPad, iPhone or Android",
    appSaveTipDesc: "On iPad/iPhone: tap the Share icon in Safari and select 'Add to Home Screen'. On Android: tap 'Install App' or 'Add to Home screen' in the browser menu.",
  ...
  ro: {
    ...
    // Settings Sections & Details
    offlineNetworkTitle: "Mod offline și rețea",
    forceOfflineTitle: "Forțează modul offline",
    forceOfflineDesc: "Simulează Wi-Fi școlar instabil sau lipsă. Folosește doar dicționarul școlar local.",
    offlinePacksTitle: "Pachete lingvistice offline instalate",
    ready100: "100% Gata",
    offlinePacksDesc: "Următoarele limbi și expresii școlare sunt salvate direct pe acest dispozitiv:",
    schoolLexicon: "Dicționar școlar",
    moreLanguagesTitle: "Instalează și gestionează alte limbi",
    moreLanguagesBadge: "Generator",
    moreLanguagesDesc: "Ai nevoie de alte limbi pentru ore? Un singur clic descarcă toate expresiile școlare pentru utilizare offline.",
    popularLanguages: "Limbi școlare populare (instalare rapidă):",
    installedBadge: "Instalat",
    deleteBtn: "Șterge",
    installBtn: "Instalează",
    addCustomLangBtn: "Adaugă altă limbă manual...",
    installCustomTitle: "Instalează orice limbă",
    langCodeLabel: "Cod (ISO)",
    langNameLabel: "Nume",
    langFlagLabel: "Steag",
    installCustomAction: "Generează și instalează pachetul",
    aiStatusTitle: "IA Școlară (Google Gemini)",
    aiActiveTitle: "Activat automat și securizat",
    aiActiveDesc: "Traducerea IA este oferită în siguranță de Heimbürgeschule. Nu ai nevoie de cheie – gata de utilizare imediat!",
    audioTitle: "Pronunție și sunet",
    speedLabel: "Viteza de citire",
    speedSlow: "0.75x (Lent / Începători)",
    speedNormal: "1.0x (Normal)",
    speedFast: "1.25x (Rapid)",
    autoPronounceTitle: "Citește automat cu voce tare",
    autoPronounceDesc: "Citește traducerea imediat ce este finalizată.",
    voiceSamplesTitle: "Ascultă mostre de voce naturală",
    voiceSamplesBadge: "Google HD și offline",
    voiceSamplesDesc: "Aplicația folosește voci de calitate pentru pronunție naturală. Offline folosește vocea dispozitivului tău:",
    voiceListenBtn: "Mostră",
    voiceStopBtn: "Stop",
    activeVoiceLabel: "Voce activă:",
    activeVoiceUsedIn: "Folosit în traducător și pentru toate expresiile școlare.",
    appSaveTipTitle: "Sfat: Salvează ca aplicație pe iPad, iPhone sau Android",
    appSaveTipDesc: "Pe iPad/iPhone: atinge pictograma Partajare din Safari și alege «Adăugare la ecranul principal». Pe Android: atinge «Instalează aplicația».",
  ...
  hu: {
    ...
    // Settings Sections & Details
    offlineNetworkTitle: "Offline mód és hálózat",
    forceOfflineTitle: "Offline mód kényszerítése",
    forceOfflineDesc: "Instabil iskolai Wi-Fi-t szimulál. Csak a helyi iskolai szótárat használja.",
    offlinePacksTitle: "Telepített offline nyelvi csomagok",
    ready100: "100% Kész",
    offlinePacksDesc: "A következő nyelvek és iskolai kifejezések közvetlenül az eszközön vannak mentve:",
    schoolLexicon: "Iskolai szótár",
    moreLanguagesTitle: "További nyelvek telepítése és kezelése",
    moreLanguagesBadge: "Generátor",
    moreLanguagesDesc: "Más nyelvekre van szükséged az órán? Egyetlen kattintással letöltheted az összes iskolai mondatot offline használatra.",
    popularLanguages: "Népszerű iskolai nyelvek (1 kattintásos telepítés):",
    installedBadge: "Telepítve",
    deleteBtn: "Törlés",
    installBtn: "Telepítés",
    addCustomLangBtn: "Más nyelv hozzáadása kézzel...",
    installCustomTitle: "Bármilyen nyelv telepítése",
    langCodeLabel: "Kód (ISO)",
    langNameLabel: "Név",
    langFlagLabel: "Zászló",
    installCustomAction: "Csomag létrehozása és telepítése",
    aiStatusTitle: "Iskolai MI (Google Gemini)",
    aiActiveTitle: "Automatikusan aktiválva és védve",
    aiActiveDesc: "A mesterséges intelligenciát a Heimbürgeschule biztosítja. Nincs szükség kulcsra – azonnal használatra kész!",
    audioTitle: "Hang és felolvasás",
    speedLabel: "Felolvasási sebesség",
    speedSlow: "0.75x (Lassú / Kezdőknek)",
    speedNormal: "1.0x (Normál)",
    speedFast: "1.25x (Gyors)",
    autoPronounceTitle: "Automatikus felolvasás",
    autoPronounceDesc: "Azonnal felolvassa a fordítást az elkészülte után.",
    voiceSamplesTitle: "Természetes hangminták meghallgatása",
    voiceSamplesBadge: "Google HD és offline",
    voiceSamplesDesc: "Az alkalmazás minőségi hangokat használ az órai kiejtéshez. Offline módban az eszköz saját hangját használja:",
    voiceListenBtn: "Minta",
    voiceStopBtn: "Állj",
    activeVoiceLabel: "Aktív hang:",
    activeVoiceUsedIn: "A fordítóban és minden iskolai kifejezésnél használatos.",
    appSaveTipTitle: "Tipp: Mentés alkalmazásként iPad-re, iPhone-ra vagy Androidra",
    appSaveTipDesc: "iPad/iPhone-on: koppints a Megosztás ikonra a Safariban és válaszd a «Főképernyőhöz adás» lehetőséget. Androidon: válaszd az «Alkalmazás telepítése» menüpontot.",
