...
export const FREQUENT_PAIRS = [
  { source: 'uk', target: 'de', label: 'UKR ➔ DE', flagTarget: '🇩🇪' },
  { source: 'ru', target: 'de', label: 'RU ➔ DE', flagTarget: '🇩🇪' },
  { source: 'en', target: 'de', label: 'EN ➔ DE', flagTarget: '🇩🇪' },
  { source: 'ro', target: 'de', label: 'RO ➔ DE', flagTarget: '🇩🇪' },
  { source: 'hu', target: 'de', label: 'HU ➔ DE', flagTarget: '🇩🇪' },
];
